package dev.ynki.util.animations.impl;
...
public class EaseBackIn extends Animation {
    ...
    public EaseBackIn(int ms, double endPoint, float easeAmount, net.minecraft.util.math.Direction.AxisDirection direction) {
