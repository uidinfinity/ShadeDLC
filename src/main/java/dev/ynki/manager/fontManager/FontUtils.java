package dev.ynki.manager.fontManager;
...
public class FontUtils {
    ...
    public final String fontsDir = "/assets/velyasik/font/";
    ...
    public static volatile RenderFonts[] velyasik = new RenderFonts[256];
    public static volatile RenderFonts[] icon = new RenderFonts[256];
    public static volatile RenderFonts[] musicRender = new RenderFonts[256];
    public static volatile RenderFonts[] mainicon = new RenderFonts[256];
    ...
    public synchronized void init() {
        ...
        initializationFont(velyasik, "velyasik.ttf");
        initializationFont(icon, "icon.ttf");
        initializationFont(musicRender, "musicRender.ttf");
        initializationFont(mainicon, "mainicon.ttf");
