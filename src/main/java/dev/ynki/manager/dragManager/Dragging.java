...
import static dev.ynki.manager.IMinecraft.mc;
...
public class Dragging {
    ...
    public void onDraw(double mouseX, double mouseY, Window window) {
        if (Manager.DRAG_MANAGER.isSelecting() || Manager.DRAG_MANAGER.hasSelection() || Manager.DRAG_MANAGER.isMovingSelection()) {
            if (dragging) {
                dragging = false;
            }
        }
        ...
        if (dragging && !Manager.DRAG_MANAGER.isSelecting()) {
    ...
    public boolean onClick(double mouseX, double mouseY, int button) {
        ...
        if (Manager.DRAG_MANAGER.isSelecting() || Manager.DRAG_MANAGER.hasSelection() || Manager.DRAG_MANAGER.isMovingSelection()) return false;
